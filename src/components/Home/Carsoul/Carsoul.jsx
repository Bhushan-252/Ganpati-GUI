...
export default function Carsoul() {
    ...
    return (
        <>
            <div className='flex bg-[rgb(250,249,255)] '>
                <div className='flex flex-col justify-around w-1/2 m-2'>
                    ...
                    <div className='border-2 border-wefront md:text-xl lg:text-3xl rounded-[5px] text-wefront mx-2 p-2 w-fit h-fit'>SHOP NOW</div>
                </div>
                <div className='relative h-0 pb-[100%] w-2/3 lg:w-1/2 mx-2'>
                    <img src={imgSrc} className='absolute rounded-2xl opacity-80 object-center object-cover h-full' alt="img" />
                </div>
            </div>
