...
export default function Carsoul() {
    ...
    return (
        <>
            <div className='flex bg-[rgb(250,249,255)] max-sm:flex-col-reverse text-justify lg:flex-col-reverse '>
                <div className='flex flex-col justify-around m-2 lg:hidden'>
                ...
                <div className='relative max-sm:pb-[60%] overflow-hidden rounded-2xl lg:w-full mx-2 lg:flex lg:justify-center'>
                    <img src={carso} fetchPriority={"high"} className='max-sm:absolute active:scale-125 transition-all duration-500 ease-in-out opacity-80 object-center object-cover max-sm:w-full lg:w-3/4 h-full' alt="img" loading={"eager"}/>
                </div>
            </div>
